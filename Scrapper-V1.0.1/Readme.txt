...
-------
Step-3 : Now open config.properties file in notepad and enter your preference.{By default the browser preference is Google Chrome.
You can change it to Firefox or IE also in Config.properties}.
--------

Step-4: Click on the Scrapper.exe icon in main folder.
------------
...
What is loading time?
 Loading time will tell your browser to wait untill page is load properly and its unit is in millisecond.
